...
- Open `./src/app/services/drinks.service.ts` to see how the front end is using the backend to deliver content for services functions. 
- Open `./src/app/services/auth.service.ts` to see how the front end is using the backend to authorize and change content based on Auth0. 
- Open `./src/environments/environments.ts` and ensure each variable reflects the system you stood up for the backend.
