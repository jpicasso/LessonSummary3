...
def create_app(test_config=None):
    ...
    def get_categoriess():
        '''
        Inputs: None
        Outputs: JSON object with List of category objects {
            'id':Integer,
            'type':'String'
            }
        '''
    ...
    def retrieve_questions():
        '''
        Inputs: Pagination number as "request"
        Outputs: JSON object with
                'questions': List of question Objects; question object has:
                    'question': String,
                    'answer': String,
                    'category': String,
                    'difficulty': Integer
                'total_questions': Integer with number of questions
                'categories': List of category objects
                'currentCategory': String with category
        '''
        try:
    ...
    def delete_question(question_id):
        '''
        Inputs: question_id as Integer
        Outputs:
            'deleted': id as Integer of question being deleted
            'questions': List of question Objects; question Object has:
                'question': String,
                'answer': String,
                'category': String,
                'difficulty': Integer
            'total_questions': number of questions as Integer
        '''
        try:
    ...
    def search_questions():
        '''
        Inputs: searchTerm as String
        Outputs:
            'questions': List of question objects; question object:
                'question': String,
                'answer': String,
                'category': String,
                'difficulty': Integer
            'totalQuestions': number of questions as Integer
        '''
    ...
    def get_quiz_questions():
        '''
        Inputs: JSON object with:
            'previous_questions': List of Integers that are question IDs
            'quiz_category': category Object {'id':Integer, 'type':'String'}
        Outputs: JSON object with
            'previousQuestions': List of Integers with question ID,
            'question': question Object, which has:
                'question': String,
                'answer': String,
                'category': String,
                'difficulty': Integer
            'guess': not sure what this does,
        '''
        try:
            ...
            for a in all_questions:
                ...
                elif int(a.category) == current_cat["id"]+1:
                    filtered_questions.append(a)
                else:
                    pass
